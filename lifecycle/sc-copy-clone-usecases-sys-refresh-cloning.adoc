...
逻辑损坏可能是由软件错误、人为错误或破坏造成的。不幸的是，逻辑损坏通常无法通过标准的高可用性和灾难恢复解决方案来解决。因此，根据发生逻辑损坏的层、应用程序、文件系统或存储，有时无法满足最大停机时间和数据丢失要求。
...
https://www.netapp.com/pdf.html?item=/media/8584-tr4646pdf.pdf["使用存储复制实现 SAP HANA 灾难恢复"]

link:../backup/hana-dr-anf-data-protection-overview.html["借助Azure NetApp Files实现SAP HANA灾难恢复"]
