...
要从源数据库执行基于Snapshot副本的自动备份并为新目标数据库创建克隆、所述的LSC与SnapCenter 集成使用中所述的配置选项和脚本 https://www.netapp.com/pdf.html?item=/media/17111-tr4667pdf.pdf["TR-4667：使用SnapCenter 自动执行SAP HANA系统复制和克隆操作"^]。
...
* https://www.netapp.com/pdf.html?item=/media/17111-tr4667pdf.pdf["TR-4667：使用SnapCenter 自动执行SAP HANA系统复制和克隆操作"^]
