...
image:saphana_aff_fc_image2b.png["八个连接到一个存储HA对的SAP HANA主机"]
...
image:saphana_aff_fc_image3b.png["连接到存储HA对的其他SAP HANA主机"]

与部署的 AFF 系统无关， SAP HANA 环境也可以通过添加任何经过认证的存储控制器来进行扩展，以满足所需的节点密度，如下图所示。

image:saphana_aff_fc_image4b.png["正在添加其他存储HA对"]
...
image:saphana_aff_fc_image6a.png["SnapMirror 解决方案"]
