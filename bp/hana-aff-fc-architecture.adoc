...
image:saphana_aff_fc_image5.png["图中显示了输入/输出对话框或表示已写入内容"]
...
有关SAP HANA备份和恢复解决方案的详细信息，请参见link:../backup/hana-br-scs-overview.html["TR-4614 ：《使用 SnapCenter 实现 SAP HANA 备份和恢复》"^]。
