...
image::saphana_aff_nfs_image2.png[saphNAS AFF NFS image2.]

下图显示了使用 VMware vSphere 作为虚拟化层的示例。

image::saphana_aff_nfs_image3.jpg[saphNAS AFF NFS image3.]
...
image::saphana_aff_nfs_image4.png[saphNAS AFF NFS image4.]

无论部署的 AFF 系统如何， SAP HANA 环境也可以通过添加任何经过认证的存储控制器来进行扩展，以满足所需的节点密度，如下图所示。

image::saphana_aff_nfs_image5.png[saphNAS AFF NFS image5.]
...
image::saphana_aff_nfs_image6.jpg[saphNAS AFF NFS image6.]
...
image::saphana_aff_nfs_image7.png[saphNAS AFF NFS image7.]
...
image::saphana_aff_nfs_image8.png[saphNAS AFF NFS image8.]
