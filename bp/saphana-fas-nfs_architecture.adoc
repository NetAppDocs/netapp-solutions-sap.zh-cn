...
image:saphana-fas-nfs_image2.png["图中显示了输入/输出对话框或表示已写入内容"]

下图显示了使用 VMware vSphere 作为虚拟化层的示例。

image:saphana-fas-nfs_image3.jpg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana-fas-nfs_image4.png["图中显示了输入/输出对话框或表示已写入内容"]

无论部署的 FAS 系统如何， SAP HANA 环境也可以通过添加任何经过认证的存储控制器来进行扩展，以满足所需的节点密度（下图）。

image:saphana-fas-nfs_image5.png["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana-fas-nfs_image6.jpg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana-fas-nfs_image8.png["图中显示了输入/输出对话框或表示已写入内容"]
