...
image::saphana-fas-nfs_image2.png[saphNAS FAS NFS image2.]

下图显示了使用 VMware vSphere 作为虚拟化层的示例。

image::saphana-fas-nfs_image3.jpg[saphNAS FAS NFS image3.]
...
image::saphana-fas-nfs_image4.png[saphNAS FAS NFS image4.]

无论部署的 FAS 系统如何， SAP HANA 环境也可以通过添加任何经过认证的存储控制器来进行扩展，以满足所需的节点密度（下图）。

image::saphana-fas-nfs_image5.png[saphNAS FAS NFS image5.]
...
image::saphana-fas-nfs_image6.jpg[saphNAS FAS NFS image6.]
...
image::saphana-fas-nfs_image7.png[saphNAS FAS NFS image7.]
...
image::saphana-fas-nfs_image8.png[saphNAS FAS NFS image8.]
