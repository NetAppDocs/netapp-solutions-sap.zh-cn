...
* FAS2750、FAS2820、FAS8300、FAS8700、FAS70、FAS9500、FAS90有关适用于SAP HANA的NetApp认证存储解决方案的完整列表，请访问 https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=v:deCertified;ve:13["经过认证并受支持的 SAP HANA 硬件目录"^]。
...
image::saphana-fas-nfs_image1.png[saphNAS FAS NFS image1]
