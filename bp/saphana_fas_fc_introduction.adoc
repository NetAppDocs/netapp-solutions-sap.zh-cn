...
* FAS2750、FAS2820、FAS9300、FAS8700、FAS9500
...
image::saphana_fas_fc_image1.png[saph单FAS fc image1.]
...
可通过多种方法将存储连接到虚拟机（ VM ）。首选方法是，将具有 NFS 的存储卷直接从子操作系统中连接起来。中介绍了此选项 https://docs.netapp.com/us-en/netapp-solutions_main/ent-apps-db/saphana_aff_nfs_introduction.html["基于采用 NFS 的 NetApp AFF 系统的 SAP HANA"^]。
