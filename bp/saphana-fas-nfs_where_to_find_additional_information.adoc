...
* TR-4667：使用SnapCenter 4.0 SAP HANA插件自动执行SAP系统副本 https://docs.netapp.com/us-en/netapp-solutions-sap/lifecycle/sc-copy-clone-introduction.html["www.netapp.com/us/media/tr-4667.pdf"^]
