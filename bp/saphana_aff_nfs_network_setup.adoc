...
image::saphana_aff_nfs_image10.png[saphNAS AFF NFS image10]
...
image::saphana_aff_nfs_image11.png[saphNAS AFF NFS image11.]
...
image::saphana_aff_nfs_image12.png[saphNAS AFF NFS image12.]
