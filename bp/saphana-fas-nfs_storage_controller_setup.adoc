...
image:saphana-fas-nfs_image16.jpg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana-fas-nfs_image17.jpg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana-fas-nfs_image18.jpg["图中显示了输入/输出对话框或表示已写入内容"]
