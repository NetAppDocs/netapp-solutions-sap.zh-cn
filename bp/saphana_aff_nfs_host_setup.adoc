...
NOTE: 自RedHat Enterprise Linux 8.6版起、还可以使用适用于SAP的RHEL系统角色(Ansible)应用这些设置。请参见 https://launchpad.support.sap.com/["SAP 注释 3024346"^] （需要 SAP 登录）。
...
NOTE: 从 ONTAP 9.8 开始， NetApp 支持 NFSv4.1 的 nconnect 选项。SLES15SP2 和 RHEL 8.4 提供了第一个支持 NFSv4.1 nconnect 的 NFS 客户端。有关追加信息，请查看 Linux 供应商文档。
