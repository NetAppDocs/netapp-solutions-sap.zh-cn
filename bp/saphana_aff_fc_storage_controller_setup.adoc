...
image::saphana_aff_fc_image10.png[saphade AFF fc image10.]
...
image::saphana_aff_fc_image11.png[saphade AFF fc image11.]
...
image::saphana_aff_fc_image12.jpg[saphade AFF fc image12.]
...
image::saphana_aff_fc_image13.jpeg[saphade AFF fc image13.]

在使用 ONTAP 9.8 System Manager 创建 SVM 期间，您可以选择所有所需的物理 FCP 端口，并自动为每个物理端口创建一个 LIF 。

image::saphana_aff_fc_image14.jpeg[saphade AFF fc image14.]
...
image::saphana_aff_fc_image15.jpeg[saphade AFF fc image15.]
...
image::saphana_aff_fc_image16.jpg[saphade AFF fc image16.]
...
image::saphana_aff_fc_image17.jpg[saphade AFF fc image17.]
...
+
image::saphana_aff_fc_image18.jpeg[saphade AFF fc image18.]

. 确认已成功配置存储。


image::saphana_aff_fc_image19.jpeg[saphade AFF fc image19.]
