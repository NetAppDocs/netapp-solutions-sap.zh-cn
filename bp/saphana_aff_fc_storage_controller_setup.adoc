...
image:saphana_aff_fc_image15.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
+
image:saphana_aff_fc_image18.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 确认已成功配置存储。


image:saphana_aff_fc_image19.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
