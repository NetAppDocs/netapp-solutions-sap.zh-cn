...
* 在 VMware 设置中，必须为每个正在运行的虚拟机分配专用 VMXNET3 网络适配器。请查看中提及的相关文件link:hana-fas-nfs-introduction.html["简介"]、了解更多要求。
...
image:saphana-fas-nfs_image11b.png["图中显示了输入/输出对话框或表示已写入内容"]
