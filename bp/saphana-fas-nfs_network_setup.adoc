...
image::saphana-fas-nfs_image10.png[saphNAS FAS NFS image10]
...
image::saphana-fas-nfs_image11.png[saphNAS FAS NFS image11.]
...
image::saphana-fas-nfs_image12.png[saphNAS FAS NFS image12.]
