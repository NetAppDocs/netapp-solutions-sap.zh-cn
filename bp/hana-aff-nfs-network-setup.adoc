...
NOTE: 根据 SAP HANA 主机的数量和使用的连接速度，需要不同数量的活动物理端口。有关详细信息，请参见一节link:hana-aff-nfs-storage-controller-setup.html#lif-configuration["LIF 配置"]。
...
image:saphana_aff_nfs_image11b.png["VMware专用网络设置"]
