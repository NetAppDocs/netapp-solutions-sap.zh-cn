...
image:saphana_fas_fc_image13.jpg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana_fas_fc_image14.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana_fas_fc_image15.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana_fas_fc_image16.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana_fas_fc_image17.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana_fas_fc_image18.jpg["图中显示了输入/输出对话框或表示已写入内容"]
...
image:saphana_fas_fc_image19.jpg["图中显示了输入/输出对话框或表示已写入内容"]
...
+
image:saphana_fas_fc_image20.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 输入 LUN 名称，选择 LUN 类型，然后输入 LUN 的大小。
+
image:saphana_fas_fc_image21.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 输入卷名称和托管聚合。
+
image:saphana_fas_fc_image22.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 选择 LUN 应映射到的 igroup 。
+
image:saphana_fas_fc_image23.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 提供 QoS 设置。
+
image:saphana_fas_fc_image24.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 单击摘要页面上的下一步。
+
image:saphana_fas_fc_image25.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 单击完成页面上的完成。
+
image:saphana_fas_fc_image26.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
+
image:saphana_fas_fc_image27.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
