...
link:amazon-fsx-backup-of-non-data-volumes.html["Previous：备份非数据卷。"]
...
link:amazon-fsx-configure-replication-relationships-on-fsx-for-ontap-file-systems.html["下一步：在ONTAP 文件系统的FSX上配置复制关系。"]
