...
image::saphana-br-scs-image82.png[saphA br sCS image82.]
...
image::saphana-br-scs-image83.png[saphA br sCS image83.]

image::saphana-br-scs-image84.png[saphA br sCS image84.]
...
image::saphana-br-scs-image85.png[saphA br sCS image81.]

以下屏幕截图显示了二级存储系统上复制目标卷 `hana SA1_data_mnt00001_dest` 的可用备份。

image::saphana-br-scs-image86.png[saphA br sCS image86]
...
+
image::saphana-br-scs-image86.5.png[saphA br sCS image86.5]

. 在顶部行中，选择立即备份图标以启动按需备份。从下拉列表中，选择备份策略 `LocalSnap` ，然后单击备份启动按需备份。
+
image::saphana-br-scs-image87.png[saphA br sCS image87]
...
+
image::saphana-br-scs-image88.png[saphA br sCS image88]

. 单击活动区域中作业的活动行时，将显示作业详细信息。您可以单击查看日志来打开详细的作业日志。
+
image::saphana-br-scs-image89.png[saphA br sCS image89]
...
+
image::saphana-br-scs-image90.png[saphA br sCS image90]

. 单击活动区域中作业的活动行时，将显示作业详细信息。
+
image::saphana-br-scs-image91.png[saphA br sCS image91.]
...
+
image::saphana-br-scs-image92.png[saphA br sCS image92.]

. 通过选择存储副本，将显示二级存储上的备份。复制的备份名称与主存储上的备份名称相同。
+
image::saphana-br-scs-image93.png[saphA br sCS image93.]
