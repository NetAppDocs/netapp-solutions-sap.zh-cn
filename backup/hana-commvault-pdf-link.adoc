...
---
= 使用 NetApp 存储系统和 Commvault 软件的 SAP HANA 备份和恢复
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
本文档描述了针对 SAP HANA 的 NetApp 和 Commvault 解决方案的设计，其中包括 Commvault IntelliSnap 快照管理技术和 NetApp Snapshot 技术。该解决方案基于 NetApp 存储和 Commvault 数据保护套件。
