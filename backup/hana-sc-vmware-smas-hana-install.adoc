...
更详细的描述请参见： link:hana-sc-generic-sc-resource-config.html#sap-hana-backup-user-and-sap-hana-user-store-configuration["用于 SAP HANA 数据库备份的 SnapCenter 资源专用配置"]
